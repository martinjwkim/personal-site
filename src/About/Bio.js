...
const Bio = ({ size }) => {
  ...
  const blurbs = [
    ...
    },
    {
      name: 'three',
      icon: <Notes />,
      paragraph: `With a little under two years of experience, I have most recently worked with Rainfall, a decentralized data intelligence platform leveraging edge-based AI and privacy-preserving blockchain technology, by developing and maintaining the front-end of the website to automate functionalities.
